...
export default function Contact() {
  ...
  const sectionBg = isDark
    ? "bg-black/60 border-t border-neutral-900"
  ...
  const footerLink = isDark ? "hover:text-gray-300" : "hover:text-gray-700";
  const divider = isDark ? "border-neutral-900" : "border-gray-200";

  return (
    <section id="contact" className={`py-24 relative overflow-hidden ${sectionBg}`}>
      {/* Background glow */}
      ...
      <div className="max-w-6xl mx-auto px-6 relative z-10">
        ...
        <div className="mb-16 text-center">
          ...
          <p className={`mt-4 max-w-xl mx-auto text-lg ${isDark ? "text-gray-400" : "text-gray-500"}`}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
          {/* Phone Card */}
          <div className={`group relative rounded-3xl border p-8 backdrop-blur-md transition-all duration-300 hover:border-violet-500/30 hover:-translate-y-1 ${cardBase}`}>
            ...
            <div className="relative z-10 flex flex-col items-center text-center">
              ...
              <h3 className={`text-xl font-bold mb-4 ${isDark ? "text-white" : "text-gray-900"}`}>Phone Numbers</h3>
              <div className="flex flex-col gap-2">
                <a
                  href="tel:+251908346566"
                  className={`text-lg transition-colors font-medium hover:underline ${isDark ? "text-gray-400 hover:text-white" : "text-gray-500 hover:text-gray-900"}`}
                >
                  +251 908 346 566
                </a>
                <a
          ...
          {/* Email Card */}
          <div className={`group relative rounded-3xl border p-8 backdrop-blur-md transition-all duration-300 hover:border-cyan-500/30 hover:-translate-y-1 ${cardBase}`}>
            ...
            <div className="relative z-10 flex flex-col items-center text-center">
              ...
              <h3 className={`text-xl font-bold mb-4 ${isDark ? "text-white" : "text-gray-900"}`}>Email Address</h3>
              <a
          ...
          {/* Telegram Card */}
          <div className={`group relative rounded-3xl border p-8 backdrop-blur-md transition-all duration-300 hover:border-sky-500/30 hover:-translate-y-1 ${cardBase}`}>
            ...
            <div className="relative z-10 flex flex-col items-center text-center">
              ...
              <h3 className={`text-xl font-bold mb-4 ${isDark ? "text-white" : "text-gray-900"}`}>Telegram</h3>
              <a
        ...
        {/* Footer */}
        <div className={`mt-24 pt-8 border-t ${divider} flex flex-col md:flex-row items-center justify-between gap-4 text-sm ${footerText}`}>
          <p>© {new Date().getFullYear()} Michael Mesfin. All rights reserved.</p>
          <div className="flex gap-6">
            <a href="#about" className={`transition-colors ${footerLink}`}>About</a>
            <a href="#projects" className={`transition-colors ${footerLink}`}>Projects</a>
            <a href="#contact" className={`transition-colors ${footerLink}`}>Contact</a>
          </div>
        </div>
      </div>
    </section>
